...
<html lang="en">
  <head>
    ...
    <title>Petro Data Account Activation</title>
  </head>
  <body>
    <div style="max-width: 600px; margin: auto; padding: 20px; font-family: Arial, sans-serif">
      <h2>Account Activation</h2>
      <p>Hello ${firstName},</p>
      <p>${adminName} (${adminEmail}) has created a data entry ${accountType} account for you on petrodata. To activate your account, please click on the link below:</p>
